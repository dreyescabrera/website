...
imgUrl: "src/assets/media/projects/torq/torq-demo.webp"
yearStart: 2023
yearEnd: 2024
highlighted: true
url: "https://app.torq.tech"
---
import torqDemoImg from "@/assets/media/projects/torq/torq-demo.webp";
import torqProjectsImg from "@/assets/media/projects/torq/torq-projects.png";
import torqDemoVideo from "@/assets/media/projects/torq/torq-demo.mp4";
...
<FullWidthImg src={torqDemoImg} alt={frontmatter.title} />
...
<FullWidthImg src={torqProjectsImg} alt="TORQ web projects" />
...
<FullWidthVideo src={torqDemoVideo} alt="TORQ dark mode toggle" />
