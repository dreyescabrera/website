...
<FullWidthImg src={frontmatter.imgUrl} alt={frontmatter.title} />
...
<FullWidthImg src="/media/torq-projects.png" alt="TORQ web projects" />
...
<FullWidthVideo src="/media/torq-demo.mp4" alt="TORQ dark mode toggle" />
